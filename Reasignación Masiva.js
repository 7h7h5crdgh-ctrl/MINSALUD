...
const CD3_SUBDIRECCIONES = {
  transmisibles:   { nombre: 'Enfermedades Transmisibles',          color: '#dc2626', emoji: '🦠',
    palabras: 'FIEBRE AMARILLA', 'LEPRA', 'ZOONOSIS', 'ETV', 'ENFERMEDADES TRANSMITIDAS POR VECTORES', 'VECTORES', 
      'VECTOR', 'COLVOL', 'HANSEN', 'TUBERCULOSIS', 'MALARIA', 'DENGUE', 'VACUNACION', 'VACUNACIÓN', 'VACUNA', 'VACUNAS', 'PAI', 'ZIKA',
      'PAIWEB', 'RED DE FRIO', 'CHAGAS', 'CUIDADOCHAGAS', 'CUIDADO CHAGAS', 'BIOLOGICOS', 'LEY DE MODERNIZACIÓN',
      'LEY DE MODERNIZACION', 'LEY 2406', 'ENFERMEDADES TROPICALES', 'TROPICALES', 'TRACOMA', 'SARAMPIÓN', 'SARAMPION', 'TOLDILLOS', 'LEISHMANIASIS', 'HEPATITIS A',
      'HEPATITIS B', 'COVID' },

  
  noTransmisibles: { nombre: 'Enfermedades No Transmisibles',       color: '#7c3aed', emoji: '❤️',
    palabras: 'CANCER, DIABETES, SALUD MENTAL, DISCAPACIDAD, HIPERTENSION, OBESIDAD' },

  
  saludAmbiental:  { nombre: 'Salud Ambiental y Cambio Climático',  color: '#059669', emoji: '🌱',
    palabras: 'CAMBIO CLIMATICO, CALIDAD DEL AIRE, RESIDUOS, AGUA POTABLE, SANEAMIENTO' },

  
  nutricion:       { nombre: 'Nutrición, Alimentación y Soberanía', color: '#d97706', emoji: '🍎',
    palabras: 'ALIMENTACION ESCOLAR, DESNUTRICION, LACTANCIA, SOBERANIA ALIMENTARIA' },
